...
import com.sparta.weeklytestspring.utils.S3Uploader;
...
public class ArticleService {
    ...
    public Article setArticle(ArticleRequestDto articleRequestDto) throws IOException {
        String image = s3Uploader.upload(articleRequestDto.getImage(), "weekly-test");
        Article article = new Article(articleRequestDto, image);
