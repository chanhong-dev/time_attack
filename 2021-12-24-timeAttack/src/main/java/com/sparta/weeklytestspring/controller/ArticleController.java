...
public class ArticleController {
    ...
    @GetMapping("/articles")
    public PagingResult<GetArticlesDto.Response> getArticles(@RequestParam(required = false) String searchTag, @PathVariable Integer curPage){
        List<Article> articles = articleService.getArticles(searchTag, curPage);
